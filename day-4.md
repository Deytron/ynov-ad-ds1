...
🌞 Connectez-vous avec cet utilisateur sur le DC (donnez-lui les droits bureau à distance au préalable) et testez d'ouvrir la console Utilisateurs Active Directory, et d'y créer un utilisateur dans l'OU déléguée
...
🌞 Dans l'OU **Utilisateurs Tier 2**, créez une sous-OU nommé `Services` et créez-y un groupe et un compte de service

🌞 Créez un compte du nom de votre choix qui servira à créer un user dans une OU donné 

🌞 Faites une délégation pour ce compte de servira, pour qu'il puisse modifier des utilisateurs (mais pas des groupes)

🌞 Créez un petit script Powershell qui prendra des paramètres dans une fonction pour venir modifier des infos d'un utilisateur dans l'OU, genre un peu comme ça :
...
🌞 Exécutez votre fonction **en tant que l'utilisateur de service (ouvrez une fenêtre Powershell en tant qu'autre utilisateur)** et vérifiez son fonctionnement. Si vous n'avez pas d'erreur, votre délégation a fonctionné

🐸 Retirez à la main la délégation que vous avez faite, et relancez votre petit script avec votre compte de service. Vous devriez avoir une erreur
